...
\Underline{Last term:} nearest neighbour electrostatic interaction. Another type of generalisation: Two different kinds of lattice points, but still only one important orbital and thus a maximum of two fermions at each.
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{Lattice with two types of lattice points, where $E_p\neq E_d$ and $p$ and $d$ are the orbital indices~\textcolor{red!80!black}{[citation missing]}.}
\end{figure}
