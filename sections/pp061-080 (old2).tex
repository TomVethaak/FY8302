...
\begin{figure}
	...
	\begin{tikzpicture}[>=stealth',scale=2]
		\draw[->,dashed] (0,1)--(0,2);
		\draw[->] (0,1)--(0.383,1.924);
		\draw[dashed] (0,1.924) ellipse (0.383cm and 0.05cm);
		\draw[->,dashed] (1,1)--(1,2);
		\draw[->] (1,1)--(1,1.974);
		\draw[dashed] (1,1.924) ellipse (0.383cm and 0.05cm);
		\draw[->,dashed] (2,1)--(2,2);
		\draw[->] (2,1)--(1.617,1.924);
		\draw[dashed] (2,1.924) ellipse (0.383cm and 0.05cm);
		\draw[->,dashed] (3,1)--(3,2);
		\draw[->] (3,1)--(3,1.874);
		\draw[dashed] (3,1.924) ellipse (0.383cm and 0.05cm);
		\draw[->,dashed] (4,1)--(4,2);
		\draw[->] (4,1)--(4.383,1.924);
		\draw[dashed] (4,1.924) ellipse (0.383cm and 0.05cm);
